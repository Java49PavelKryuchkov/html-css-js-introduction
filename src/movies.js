...
const ulElement = document.querySelectorAll(".movies-list");
ulElement.innerHTML = getPosterImages();
// const abc = document.querySelector(".most-popular-movie");
// abc.innerHTML = getPopularMovie();
...
//     const popMovieAr = moviesData.results.reduce((res, cur) => {
//         if (res.popularity < cur.popularity) {
//         `<li class="movie-item">
//        <image class="movie-image" src="${httpPrefix}${cur.popularity}">
//        <div class="subsection">
//        <span class="movie-title">${cur.original_title}</span>
//        <span class="movie-description">${cur.overview}</span>
//        </div>
//        </li>`
//         }
//     }, 0)
//     return popMovieAr.join('');
